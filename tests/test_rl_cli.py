...
from pokestrategist.cli.train_rl import main as rl_main
from pokestrategist.models import PokeStrategistDecisionModel

from tests.v1_fixtures import write_dataset


def test_train_mc_q_cli_smoke(tmp_path, monkeypatch):
    ...
    assert "mc_config" in checkpoint
    ...
    assert "mc_q_loss" in metrics or "mc_v_loss" in metrics
